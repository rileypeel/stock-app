...
urlpatterns = [
	...
	path('portfolio/transaction/<int:id>', views.TransactionDetailView.as_view(), name='transaction-detail'),
	path('portfolio/<int:id>/transaction', views.TransactionView.as_view(), name='transaction-list')
]
