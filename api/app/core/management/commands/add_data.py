...
class Command(BaseCommand):
	...
	def add_arguments(self, parser):
		parser.add_argument('-t', '--tickers', nargs='+', help="list of tickers to add to the database")
		parser.add_argument('-d', '--default', action='store_true', help='add default ticker list')
